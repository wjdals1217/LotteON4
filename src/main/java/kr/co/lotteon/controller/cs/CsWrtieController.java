...
@Controller
@Log4j2
public class CsWrtieController {

    @Autowired
    private CsService service;

    @GetMapping("/cs/qna/write")
    public String write(@RequestParam("cate1") String cate1, @RequestParam("cate2") String cate2, Model model){
    ...
    @GetMapping("/cs/qna/write/selectcate2")
    @ResponseBody
